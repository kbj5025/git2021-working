...
public class TestTodoController {
	...
	void removeTodo() {
		...
		assertEquals(0, afterTodos.size()); // 삭제후에는 목록 크기가 0
	}
	...
	void modifyTodo() {
		...
		// basic flow -정상적인 상황
		// when
		// 테스트 케이스의 event flow를 수행 // id가 1인 todo memo를 수정
		...
		// altanative flow - 2-1. 메모값이 null인 경우
		// when
		...
		// altanative flow - 2-2. 메모값이 빈값("")인 경우
		// when
